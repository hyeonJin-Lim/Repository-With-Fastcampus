    ...
    public static void select(){
        ...
        switch (setmenu){
            case 1:
                ...
                break;
            case 2:
                if(vip.minMoney ==20000){
                    System.out.println("등급: "+grade);
                    System.out.println("기본 최소 사용금액: "+minMoney+"원");
                    System.out.println("최소 사용금액은 "+general.getMinMoney()+"원 보다 커야합니다.");
                    System.out.print("최소 사용금액을 입력하세요: ");
                    int money = Exception.scannerInt();
                    if(money>general.getMinMoney()) {
    ...
    public static void select2(){
        ...
        switch (set2menu){
            case 1:
                ...
                break;
            case 2:
                System.out.println(grade+" 등급의 최소 사용금액은 "+general.getMinMoney()+"원 보다 커야합니다.");
                ...
                if(money>general.getMinMoney()) {
                    ...
                    System.out.println(general.getMinMoney()+"원 보다 커야합니다.");
                    System.out.println();
                }
                break;
            case 3:
