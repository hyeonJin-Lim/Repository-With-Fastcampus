...
public class vvip extends none{
    private static int minTime =30;
    private static int minMoney=200000;
    ...
    public static void select(){
        ...
        switch (setmenu){
            case 1:
                ...
                break;
            case 2:
                if(vvip.minMoney ==50000){
                    System.out.println("등급: "+grade);
                    System.out.println("기본 최소 사용금액: "+minMoney+"원");
                    System.out.println("최소 사용금액은 "+vip.getMinMoney()+"원 보다 커야합니다.");
        ...
        switch (set2menu){
            ...
            case 2:
                ...
                if(money>vip.getMinMoney()) {
                    ...
                    System.out.println(vip.getMinMoney()+"원 보다 커야합니다.");
                    System.out.println();
                }
                break;
            case 3:
